...
#ifndef __spk_packet_rx_mul_6ns_6ns_11_3__HH__
#define __spk_packet_rx_mul_6ns_6ns_11_3__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(spk_packet_rx_mul_6ns_6ns_11_3) {
    ...
    SC_CTOR(spk_packet_rx_mul_6ns_6ns_11_3):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
