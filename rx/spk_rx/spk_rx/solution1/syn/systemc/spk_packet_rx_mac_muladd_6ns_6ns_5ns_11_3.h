...
#ifndef __spk_packet_rx_mac_muladd_6ns_6ns_5ns_11_3__HH__
#define __spk_packet_rx_mac_muladd_6ns_6ns_5ns_11_3__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(spk_packet_rx_mac_muladd_6ns_6ns_5ns_11_3) {
    ...
    SC_CTOR(spk_packet_rx_mac_muladd_6ns_6ns_5ns_11_3):  simcore_mac_0_U ("simcore_mac_0_U") {
