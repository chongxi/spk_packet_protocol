...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "spk_packet_rx.autotvin.dat"
	set constFileTvOut       "spk_packet_rx.autotvout.dat"
	set constFileHdlTvIn     "spk_packet_rx.autohdltvin.dat"
	set constFileHdlTvOut    "spk_packet_rx.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
