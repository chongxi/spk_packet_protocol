...
if {[file isfile spk_packet_rx.autotvin.dat]} {
	file delete -force spk_packet_rx.autotvin.dat
}

if {[file isfile spk_packet_rx.autotvout.dat]} {
	file delete -force spk_packet_rx.autotvout.dat
}
