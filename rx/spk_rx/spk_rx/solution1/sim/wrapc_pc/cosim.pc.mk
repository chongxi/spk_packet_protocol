...
$(ObjDir)/spk_packet_rx_test.cpp_pre.cpp.tb.o : spk_packet_rx_test.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling spk_packet_rx_test.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \

$(ObjDir)/spk_packet_rx.cpp_pre.cpp.tb.o : spk_packet_rx.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling spk_packet_rx.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) gcc -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG)  $< -o $@; \
