...
HD_PWD='/vivado_proj/spk_packet_protocol/rx/spk_rx/spk_rx/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spk_packet_rx.vdi -applog -m64 -messageDb vivado.pb -mode batch -source spk_packet_rx.tcl -notrace
