...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "spk_packet_tx.autotvin.dat"
	set constFileTvOut       "spk_packet_tx.autotvout.dat"
	set constFileHdlTvIn     "spk_packet_tx.autohdltvin.dat"
	set constFileHdlTvOut    "spk_packet_tx.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
