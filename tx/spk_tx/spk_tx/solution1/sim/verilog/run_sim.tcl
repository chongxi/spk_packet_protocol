...
if {[file isfile spk_packet_tx.autotvin.dat]} {
	file delete -force spk_packet_tx.autotvin.dat
}

if {[file isfile spk_packet_tx.autotvout.dat]} {
	file delete -force spk_packet_tx.autotvout.dat
}
