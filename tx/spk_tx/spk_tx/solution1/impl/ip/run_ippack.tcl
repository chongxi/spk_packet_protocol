...
set Interfaces {
    ap_clk {
        ...
        buses "mua_stream out_pre out_post time_stamp_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 4.000000 machine 64 combinational 0 latency 5 II 1}
...
set enable_xo_gen 0
set kernel_files {/vivado_proj/spk_packet_protocol/tx/spk_packet_tx.cpp}
if {$enable_xo_gen} {
