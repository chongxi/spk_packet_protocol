...
HD_PWD='/vivado_proj/spk_packet_protocol/tx/spk_tx/spk_tx/solution1/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spk_packet_tx.vds -m64 -mode batch -messageDb vivado.pb -notrace -source spk_packet_tx.tcl
