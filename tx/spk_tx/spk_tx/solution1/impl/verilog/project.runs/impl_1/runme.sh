...
HD_PWD='/vivado_proj/spk_packet_protocol/tx/spk_tx/spk_tx/solution1/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log spk_packet_tx.vdi -applog -m64 -messageDb vivado.pb -mode batch -source spk_packet_tx.tcl -notrace
